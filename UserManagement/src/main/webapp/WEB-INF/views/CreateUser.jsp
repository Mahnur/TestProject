...
<html>
  ...
  <body ng-app="myApp" class="ng-cloak">
	...
	<div class="w3-container"  ng-controller="CreateUserController as userCtrl">
	...
	<form name="myForm" ng-hide="hideform">
	  ...
	  <p>
	    ...
	    <input class="w3-input w3-border" type="text"  name="uID" ng-model="userCtrl.user.id"  placeholder="User ID" required>
		<span ng-show="myForm.uID.$touched && myForm.uID.$invalid">*User ID is required.</span>
	  <br>
	  </p>
	  ...
	  <br>
	   ...
	   <p>
	    ...
	    <select class="w3-select w3-border" name="uRole" ng-model="userCtrl.selectedRole" ng-options="role as role.value for role in userCtrl.userRoles">
		</select>
	  <br>
	  </p>
	  ...
	  <button class="w3-btn w3-green w3-ripple" ng-disabled="myForm.$invalid" ng-click="userCtrl.createUser()">&#9998; Create</button>
	  <button class="w3-btn w3-red w3-ripple" ng-click="userCtrl.cancelCreateUser()">&#9998; Cancel</button>
      ...
      <script src="<c:url value='/static/js/controller/create_user_controller.js' />"></script>
